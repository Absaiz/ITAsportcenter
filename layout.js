...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // 2. INYECTAR ESTILOS DEL MENÚ (CSS IN-JS)
    ...
    btnMenu.addEventListener('click', () => {
        if (menuDiv.style.display === "none") {
            ...
            btnMenu.innerHTML = '<i class="bi bi-x-lg"></i>'; // Cambiar a X
        } else {
            menuDiv.style.display = "none";
            btnMenu.innerHTML = '<i class="bi bi-list"></i>'; // Cambiar a Hamburguesa
        }
    });

    console.log("APP LISTA: Menu + Footer + WhatsApp cargados.");
});
}, false);